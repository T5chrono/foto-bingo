...
| **Wiersz 5** | Ktoś, kto trzyma dwa drinki naraz | Gwiazdy albo nocne niebo | Ktoś, kto próbuje uciec przed zdjęciem | Ktoś, kto płacze ze wzruszenia | Cała drużyna z gry weselnej |

## English, w układzie karty
...
| **Wiersz 5** | Someone holding two drinks at once | Stars, or the night sky | Someone trying to escape the camera | Someone crying happy tears | The whole team from the wedding game |

## Srpski, w układzie karty
...
| **Wiersz 5** | Neko sa dva pića u rukama | Zvezde ili noćno nebo | Neko ko beži od fotografisanja | Neko ko plače od ganutosti | Ceo tim iz svadbene igre |

## Deutsch, w układzie karty
...
| **Wiersz 5** | Jemand mit zwei Drinks auf einmal | Sterne oder der Nachthimmel | Jemand, der vor der Kamera flieht | Jemand, der Freudentränen weint | Das ganze Team aus dem Hochzeitsspiel |

## Wszystko obok siebie

Slug wchodzi w nazwę pliku na Dysku — `R3K2_moment-ceremonii-slubnej__anna-kowalska__…`.

| # | Pole | Polski | English | Srpski | Deutsch | Slug |
| --- | --- | --- | --- | --- | --- |
...
| 7 | R2K2 | Najgorsze możliwe zdjęcie grupowe | The worst possible group photo | Najgora moguća grupna fotografija | Das schlechtestmögliche Gruppenfoto | `najgorsze-mozliwe-zdjecie-grupowe` |
| 8 | R2K3 | Bukiet panny młodej z bliska | The bride's bouquet, up close | Mladin buket izbliza | Der Brautstrauß aus der Nähe | `bukiet-panny-mlodej-z-bliska` |
| 9 | R2K4 | Zdjęcie z obiema mamami | A photo with both mums | Fotografija sa obe mame | Ein Foto mit beiden Müttern | `zdjecie-z-obiema-mamami` |
| 10 | R2K5 | Ktoś, kto zasnął | Someone who fell asleep | Neko ko je zaspao | Jemand, der eingeschlafen ist | `ktos-kto-zasnal` |
| 11 | R3K1 | Trzy pokolenia na jednym zdjęciu | Three generations in one photo | Tri generacije na jednoj fotografiji | Drei Generationen auf einem Foto | `trzy-pokolenia-na-jednym-zdjeciu` |
| 12 | R3K2 | Moment ceremonii ślubnej | A moment from the wedding ceremony | Trenutak sa venčanja | Ein Moment der Trauung | `moment-ceremonii-slubnej` |
| 13 | R3K3 | Pierwszy taniec | The first dance | Prvi ples | Der erste Tanz | `pierwszy-taniec` |
| 14 | R3K4 | Uchwycona wpadka | A mishap caught on camera | Uhvaćen gaf | Eine Panne im Bild | `uchwycona-wpadka` |
| 15 | R3K5 | Ktoś tańczący z zamkniętymi oczami | Someone dancing with their eyes closed | Neko ko pleše zatvorenih očiju | Jemand, der mit geschlossenen Augen tanzt | `ktos-tanczacy-z-zamknietymi-oczami` |
| 16 | R4K1 | Ktoś owinięty kocem | Someone wrapped in a blanket | Neko umotan u ćebe | Jemand in eine Decke gewickelt | `ktos-owiniety-kocem` |
| 17 | R4K2 | Tort przed pokrojeniem | The cake before it's cut | Torta pre sečenja | Die Torte, bevor sie angeschnitten wird | `tort-przed-pokrojeniem` |
| 18 | R4K3 | Świadkowie razem | The witnesses together | Kum i kuma zajedno | Die Trauzeugen zusammen | `swiadkowie-razem` |
| 19 | R4K4 | Kreatywne zdjęcie z basenu | A creative shot from the pool | Kreativna fotografija sa bazena | Ein kreatives Foto aus dem Pool | `kreatywne-zdjecie-z-basenu` |
| 20 | R4K5 | Najlepszy widok z tarasu | The best view from the terrace | Najbolji pogled sa terase | Der beste Blick von der Terrasse | `najlepszy-widok-z-tarasu` |
| 21 | R5K1 | Ktoś, kto trzyma dwa drinki naraz | Someone holding two drinks at once | Neko sa dva pića u rukama | Jemand mit zwei Drinks auf einmal | `ktos-kto-trzyma-dwa-drinki-naraz` |
| 22 | R5K2 | Gwiazdy albo nocne niebo | Stars, or the night sky | Zvezde ili noćno nebo | Sterne oder der Nachthimmel | `gwiazdy-albo-nocne-niebo` |
| 23 | R5K3 | Ktoś, kto próbuje uciec przed zdjęciem | Someone trying to escape the camera | Neko ko beži od fotografisanja | Jemand, der vor der Kamera flieht | `ktos-kto-probuje-uciec-przed-zdjeciem` |
| 24 | R5K4 | Ktoś, kto płacze ze wzruszenia | Someone crying happy tears | Neko ko plače od ganutosti | Jemand, der Freudentränen weint | `ktos-kto-placze-ze-wzruszenia` |
| 25 | R5K5 | Cała drużyna z gry weselnej | The whole team from the wedding game | Ceo tim iz svadbene igre | Das ganze Team aus dem Hochzeitsspiel | `cala-druzyna-z-gry-weselnej` |
